 ...
 */
final class Version20210107175056 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event ADD id_user_id INT NOT NULL, CHANGE player_1 player_1 INT DEFAULT NULL, CHANGE player_2 player_2 INT DEFAULT NULL, CHANGE player_3 player_3 INT DEFAULT NULL, CHANGE player_4 player_4 INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event DROP id_user_id, CHANGE player_1 player_1 INT DEFAULT NULL, CHANGE player_2 player_2 INT DEFAULT NULL, CHANGE player_3 player_3 INT DEFAULT NULL, CHANGE player_4 player_4 INT DEFAULT NULL');
